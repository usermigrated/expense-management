  ...
  <div className="grid gap-4 text-xs py-3">
    ...
    <div className="flex justify-between items-center">
      ...
      <select
        value={currency}
        onChange={(e) => setCurrency(e.target.value)}
        className="h-8 w-10/12 rounded border border-slate-300 bg-white px-2 dark:border-slate-700 dark:bg-slate-900"
      >
        <option value="£">£</option>
        <option value="$">$</option>
        <option value="€">€</option>
                  ...
                  >
                    ...
                    {/* <span className="text-center"> */}
                      <button
                        ...
                        className="text-[11px] ml-3 font-medium text-rose-500 hover:text-rose-600 dark:text-rose-400 dark:hover:text-rose-300"
                      >
